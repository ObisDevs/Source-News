    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Source News</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              AI-powered Nigerian news aggregation with bias detection and multi-viewpoint analysis.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/timeline" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                  Timeline
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 md:mt-0">
              Built with AI-powered news intelligence
            </p>
          </div>
        </div>
      </div>
